/*
  # Fix Email Branding - Garantie Pro-Remorque

  ## Problem
  - Email template uses "Location Pro-Remorque"
  - Wrong domain: locationproremorque.ca
  - Should use: "Garantie Pro-Remorque" and garantieproremorque.com

  ## Solution
  - Update email trigger to use correct branding
  - Update company name to "Garantie Pro-Remorque"
  - Update domain to garantieproremorque.com
*/
...
BEGIN
  ...
  -- Build DIRECT Supabase URL for download
  ...
  -- Build claim submission URL with correct domain
  IF NEW.claim_submission_url IS NOT NULL THEN
    v_claim_url := NEW.claim_submission_url;
  ELSE
    v_claim_url := 'https://www.garantieproremorque.com/claim/' || NEW.id::text;
  END IF;

  -- Insert into email queue with CORRECT BRANDING
  INSERT INTO email_queue (
    ...
    v_customer_email,
    'Votre garantie ' || v_contract_number || ' - Garantie Pro-Remorque',
    format('<!DOCTYPE html>
<html lang="fr">
<head>
  <meta charset="UTF-8">
        ...
        <table width="100%%" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #dc2626 0%%, #b91c1c 100%%); padding: 50px 40px; text-align: center;">
              <h1 style="color: #ffffff; font-size: 32px; font-weight: 800; margin: 0 0 12px;">Garantie Pro-Remorque</h1>
          ...
          <tr>
            <td style="padding: 48px 40px;">
              ...
              <p style="color: #334155; font-size: 16px; line-height: 1.6; margin: 0 0 32px;">
                Votre garantie <strong>%s</strong> a été créée avec succès. Vous pouvez télécharger votre contrat PDF et soumettre des réclamations via les liens ci-dessous.
              </p>
              ...
              <table width="100%%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="padding: 0 0 32px;">
                    <table cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="background: linear-gradient(135deg, #2563eb 0%%, #1d4ed8 100%%); border-radius: 12px; box-shadow: 0 4px 12px rgba(37, 99, 235, 0.3);">
                          <a href="%s" style="display: block; color: #ffffff; text-decoration: none; padding: 16px 48px; font-size: 16px; font-weight: 700; letter-spacing: 0.5px;">
                ...
                <tr>
                  <td>
                    <p style="color: #92400e; font-size: 13px; line-height: 1.6; margin: 0;">
                      🔒 <strong>Liens sécurisés:</strong> Ces liens sont uniques et sécurisés pour vous. Conservez cet email pour vos dossiers.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="background-color: #f8fafc; padding: 32px 40px; text-align: center; border-top: 1px solid #e2e8f0;">
              <p style="color: #64748b; font-size: 14px; margin: 0 0 8px;">
                <strong style="color: #334155;">Garantie Pro-Remorque</strong>
              </p>
              <p style="color: #94a3b8; font-size: 12px; margin: 0 0 4px;">
                Gestion professionnelle de garanties
              </p>
              <p style="color: #94a3b8; font-size: 12px; margin: 0;">
                <a href="https://www.garantieproremorque.com" style="color: #3b82f6; text-decoration: none;">www.garantieproremorque.com</a>
              </p>
            </td>
          </tr>
...
DO $$
BEGIN
  RAISE NOTICE '✅ Email branding updated to Garantie Pro-Remorque';
  RAISE NOTICE '   Company name: Garantie Pro-Remorque';
  RAISE NOTICE '   Domain: www.garantieproremorque.com';
  RAISE NOTICE '   Subject line updated';
  RAISE NOTICE '   Footer links updated';
END $$;
