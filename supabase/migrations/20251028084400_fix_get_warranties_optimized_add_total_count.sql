/*
  # Fix get_warranties_optimized to include total count

  1. Changes
    - Add total_count to return table
    - Calculate total count with window function
    
  2. Security
    - Maintains organization_id filtering
*/

-- Drop and recreate with total_count
