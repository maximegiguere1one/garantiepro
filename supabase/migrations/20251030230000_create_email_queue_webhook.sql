...
BEGIN
  RAISE NOTICE '========================================';
  RAISE NOTICE 'Webhook email_queue créé avec succès!';
  RAISE NOTICE '========================================';
  RAISE NOTICE '';
  RAISE NOTICE 'Les emails seront maintenant traités automatiquement';
  RAISE NOTICE 'dès qu''ils sont ajoutés dans la queue.';
  RAISE NOTICE '';
  RAISE NOTICE 'Pour configurer les clés (si nécessaire):';
  RAISE NOTICE '1. Aller dans Supabase Dashboard';
  RAISE NOTICE '2. Settings > API > Project API keys';
  RAISE NOTICE '3. Copier anon/public key';
  RAISE NOTICE '4. Exécuter:';
  RAISE NOTICE '   ALTER DATABASE postgres SET app.settings.supabase_anon_key = ''YOUR_KEY'';';
  RAISE NOTICE '';
  RAISE NOTICE 'Test: Créer une garantie et vérifier email_queue';
  RAISE NOTICE '========================================';
END $$;
