/*
  # Correction de la fonction delete_warranty_with_cascade - action en minuscule

  1. Modifications
    - Change l'action de 'DELETE' à 'delete' pour respecter la contrainte audit_log_action_check
*/
...
BEGIN
  ...
  -- 4. Créer une entrée d'audit avant suppression (action en minuscule)
