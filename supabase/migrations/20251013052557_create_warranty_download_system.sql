...
CREATE INDEX IF NOT EXISTS idx_warranty_download_tokens_token ON warranty_download_tokens(token) WHERE is_active = true;
CREATE INDEX IF NOT EXISTS idx_warranty_download_tokens_warranty ON warranty_download_tokens(warranty_id);
CREATE INDEX IF NOT EXISTS idx_warranty_download_tokens_organization ON warranty_download_tokens(organization_id);
CREATE INDEX IF NOT EXISTS idx_warranty_download_tokens_expires ON warranty_download_tokens(expires_at) WHERE is_active = true;
...
CREATE INDEX IF NOT EXISTS idx_warranty_download_logs_token ON warranty_download_logs(token_id);
CREATE INDEX IF NOT EXISTS idx_warranty_download_logs_accessed_at ON warranty_download_logs(accessed_at DESC);
CREATE INDEX IF NOT EXISTS idx_warranty_download_logs_ip ON warranty_download_logs(ip_address);
CREATE INDEX IF NOT EXISTS idx_warranty_download_logs_result ON warranty_download_logs(access_result);
...
DROP POLICY IF EXISTS "Users can view own organization tokens" ON warranty_download_tokens;
...
DROP POLICY IF EXISTS "System can create tokens" ON warranty_download_tokens;
CREATE POLICY "System can create tokens"
  ON warranty_download_tokens FOR INSERT
  TO authenticated
  WITH CHECK (true);

DROP POLICY IF EXISTS "Users can update own organization tokens" ON warranty_download_tokens;
...
DROP POLICY IF EXISTS "Admins can delete tokens" ON warranty_download_tokens;
...
DROP POLICY IF EXISTS "Users can view own organization logs" ON warranty_download_logs;
...
DROP POLICY IF EXISTS "System can insert logs" ON warranty_download_logs;
...
DROP TRIGGER IF EXISTS warranty_download_tokens_updated_at ON warranty_download_tokens;
