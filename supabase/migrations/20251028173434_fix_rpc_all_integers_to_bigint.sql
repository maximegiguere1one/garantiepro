/*
  # Fix RPC - Convert all INTEGER to BIGINT for compatibility
  
  1. Changes
    - Convert all INTEGER types to BIGINT in RETURNS TABLE
    - This ensures compatibility with PostgREST numeric mapping
*/
