/*
  # Fix get_warranties_optimized to return complete customer and trailer data

  1. Changes
    - Add all missing customer fields (email, phone, address, city, province, postal_code)
    - Add all missing trailer fields (year, length, gvwr, color)
    - Add missing warranty fields (start_date, end_date, plan_duration_months, base_price, add_ons)
    - Add plan details (price, duration)
...
-- Drop and recreate with complete field list
