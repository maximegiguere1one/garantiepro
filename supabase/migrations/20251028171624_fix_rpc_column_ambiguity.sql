/*
  # Fix RPC - Resolve column ambiguity
  
  1. Changes
    - Rename output columns to avoid conflicts with internal variables
    - Use p_ prefix for parameters, w_ prefix for warranty columns
*/
